...
import { RoutePricesModal } from "./RoutePriceModal";
...
export const RoutesList = () => {
  ...
  // );
  const [columns, setColumns] = useState(routesPayload.columns);
  ...
  const handleOpenModal = (row) => {
    ...
    setSelectedRouteName(row.name);
    setSelectedRouteType(row.vehicles_type.name);
    setModalOpen(true);
  };
