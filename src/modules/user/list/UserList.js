...
export const UserList = () => {
  ...
  const [columns, setColumns] = useState(
    getData(userPayload.columnsName) == null
      ? userPayload.columns
      : getData(userPayload.columnsName)
  );
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <Paper sx={{ width: "100%", overflow: "hidden", marginTop: "10px" }}>
          <div className="pt-2 flex flex-wrap max-w-screen items-center gap-5">
            <TableCustomizeSetting
              payload={userPayload.columns}
              columns={columns}
